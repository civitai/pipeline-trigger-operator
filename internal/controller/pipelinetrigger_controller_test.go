			...
			webhookConfig := &admissionregistrationv1.ValidatingWebhookConfiguration{
				...
				Webhooks: []admissionregistrationv1.ValidatingWebhook{{
					...
					ClientConfig: admissionregistrationv1.WebhookClientConfig{
						...
						// connection refused".
						URL: webhookPtr("https://127.0.0.1:1/reject"),
					},
					Rules: []admissionregistrationv1.RuleWithOperations{{
						...
						Rule: admissionregistrationv1.Rule{
							...
							Scope:       webhookPtr(admissionregistrationv1.AllScopes),
						},
					}},
					FailurePolicy:           webhookPtr(admissionregistrationv1.Fail),
					SideEffects:             webhookPtr(admissionregistrationv1.SideEffectClassNone),
					AdmissionReviewVersions: []string{"v1"},
					TimeoutSeconds:          webhookPtr(int32(5)),
				}},
			}
...
// webhookPtr returns a pointer to v (test helper for building typed
// admissionregistration objects on this older toolchain, which predates
// k8s.io/utils/ptr).
func webhookPtr[T any](v T) *T { return &v }
